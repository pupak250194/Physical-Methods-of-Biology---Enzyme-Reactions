...
sys.path.append(r"C:/Users/39333/Desktop/Physical-Methods-of-Biology---Enzyme-Reactions-main/Differential-Eqs")
print(sys.path)
...
def start_simulation():
    ...
    Full_Model_Solution = odeint (SimulationFunctionsOnly_ES.Full_Model, initial_conditions, time_span, args=(simkf, simkb, simkcat, initial_S, initial_E))
    QSSAsolution = odeint (SimulationFunctionsOnly_ES.QSSA, initial_conditions, time_span, args=(simkcat, simkM, initial_S, initial_E))
    tQSSAsolution = odeint (SimulationFunctionsOnly_ES.tQSSA, initial_conditions, time_span, args=(simkcat, simkM, initial_S, initial_E))
